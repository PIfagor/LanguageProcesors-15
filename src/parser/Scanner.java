...
/**
 * A lexical analyzer, that has no backtracking mechanism.
 * 
...
class Scanner {
    ...
    public Scanner(String fileName) throws FileNotFoundException {
        ...
        reserved.put(BEGIN.image(), BEGIN);
        ...
        reserved.put(END.image(), END);
        reserved.put(LAND.image(), LAND);
        reserved.put(INTEGER.image(), INTEGER);
        reserved.put(NULL.image(), NULL);
        reserved.put(LNOT.image(), LNOT);
        reserved.put(PRIVATE.image(), PRIVATE);
        reserved.put(VAR.image(), VAR);
        reserved.put(PUBLIC.image(), PUBLIC);
        reserved.put(THEN.image(), THEN);
        reserved.put(TRUE.image(), TRUE);
        reserved.put(WHILE.image(), WHILE);
        
        reserved.put(ARRAY.image(), ARRAY);
        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                if (ch == '/') {
                    ...
                    reportScannerError("Operator / is not supported.");
                }
            } else {
