...
public class pascal implements pascalConstants {
  ...
  static final public int define() throws ParseException {
  ...
  static final public void listOfVars() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IDENTIFIER:
  ...
  static final public void typeRef() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ARRAY:
      arrayRef();
      break;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4000800,0x40000,0x1040000,0x5000,};
   }
